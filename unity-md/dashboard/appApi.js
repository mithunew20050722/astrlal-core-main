/**
 * UNITY-MD App API
 * Copy this file to your UNITY_FAST project root: dashboard/appApi.js
...
module.exports = function registerAppApi(app, getSm, db) {
  ...
  app.post('/api/app/otp/send', async (req, res) => {
    try {
      ...
      // Try session sock first, fallback to global unitySock
      const sock = session?.sock || global.unitySock;
