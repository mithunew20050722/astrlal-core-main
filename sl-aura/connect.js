'use strict';
/**
 * SL AURA — Multi-User Entry Point
...
async function main() {
  ...
  global.astraSessionManager = sessionManager;  // ← mgmt bot needs this
  startDashboard(sessionManager);

  // Restore sessions AFTER dashboard is ready — 5s delay lets everything stabilize
  setTimeout(async () => {
