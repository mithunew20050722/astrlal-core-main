...
function decodeSessionId(raw) {
  if (!raw || raw === 'SL AURA_' || raw === 'SL AURA') return null;

  // Strip known prefix  e.g. "SL AURA;base64..."  "LEVANTER;base64..."
...
async function importSession() {
  ...
  if (!rawId || rawId === 'SL AURA_' || rawId === 'SL AURA') {
