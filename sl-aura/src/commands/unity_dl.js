...
async function handlePendingDownload(sock, m) {
  ...
  if (pending.type === 'song') {
    ...
    if (choice === '4') {
      ...
      if (buttonKey) { try { await sock.sendMessage(chat, { delete: buttonKey }); } catch {} }
      pendingDownload.delete(sender);
      try { await sock.sendMessage(chat, { text: `📋 *AURA Main Menu*\n━━━━━━━━━━━━━━━━━━━━━━\n${footer}` }, { quoted: pending.quotedMsg }); } catch {}
      // trigger .menu
      try {
...
module.exports = {
  ...
  async run({ sock, m }) {
    ...
    if (cmd === 'ss' || cmd === 'screenshot') {
      ...
      if (imgBuffer) {
        await sock.sendMessage(chat, { image: imgBuffer, caption: `📸 *AURA Screenshot*\n🔗 ${q}\n━━━━━━━━━━━━━━━━━━━━━━\n${footer}` }, { quoted: m.msg });
    ...
    if (cmd === 'ytcomment') {
      ...
      if (imgBuffer) return sock.sendMessage(chat, { image: imgBuffer, caption: `💬 *AURA YouTube Comment*\n${username}: ${q}\n━━━━━━━━━━━━━━━━━━━━━━\n${footer}` }, { quoted: m.msg });
      return m.reply(`💬 *AURA YouTube Comment*\n👤 ${username}: ${q}\n━━━━━━━━━━━━━━━━━━━━━━\n${footer}`);
    }
    ...
    if (cmd === 'blur') {
      ...
      try {
        ...
        try {
          ...
          return m.reply(`❌ Blur failed: ${e.message}\n\n${footer}`);
        }
      } catch (e) { return m.reply(`❌ Error: ${e.message}\n\n${footer}`); }
    }
    ...
    if (['imagine', 'flux', 'sora'].includes(cmd)) {
      ...
      if (imgBuffer) {
        await sock.sendMessage(chat, { image: imgBuffer, caption: `🎨 *AURA AI Generated Image*\n✨ *Prompt:* ${q}\n🤖 *Model:* ${cmd}\n━━━━━━━━━━━━━━━━━━━━━━\n${footer}` }, { quoted: m.msg });
        try { await sock.sendMessage(chat, { delete: waitMsg.key }); } catch {}
      } else {
