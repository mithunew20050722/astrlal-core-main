...
const { sendButtons, toSmallCaps } = require('./helper');
...
const subMenus = {
  ...
  bot: {
    title: `🖤 ${toSmallCaps('Bot')} ${toSmallCaps('Controls')}`,
    commands: [
  ...
  group: {
    title: `🖤 ${toSmallCaps('Group')} ${toSmallCaps('Management')}`,
    commands: [
  ...
  ai: {
    title: `🖤 ${toSmallCaps('AI')} & ${toSmallCaps('Search')}`,
    commands: [
      ['.ai',           'Gemini AI Chat'],
      ['.gpt',          'GPT AI Chat'],
  ...
  sticker: {
    title: `🖤 ${toSmallCaps('Sticker')} & ${toSmallCaps('Media')}`,
    commands: [
  ...
  fun: {
    title: `🖤 ${toSmallCaps('Fun')} & ${toSmallCaps('Memes')}`,
    commands: [
      ['.aura',          '🌌 Daily Aura Reading (SL AURA exclusive)'],
      ['.joke',          'Random Joke'],
  ...
  tools: {
    title: `🖤 ${toSmallCaps('Tools')} & ${toSmallCaps('Utilities')}`,
    commands: [
      ['.tts',         'Text to Speech'],
      ['.tr',          'Translate'],
  ...
  anime: {
    title: `🖤 ${toSmallCaps('Anime')} & ${toSmallCaps('Manga')}`,
    commands: [
  ...
  privacy: {
    title: `🖤 ${toSmallCaps('Privacy')} ${toSmallCaps('Settings')}`,
    commands: [
  ...
  auto: {
    title: `🖤 ${toSmallCaps('Auto')} ${toSmallCaps('Systems')}`,
    commands: [
  ...
  channel: {
    title: `🖤 ${toSmallCaps('Channel')} & ${toSmallCaps('Broadcast')}`,
    commands: [
  ...
  srilanka: {
    title: `🖤 ${toSmallCaps('Sri')} ${toSmallCaps('Lanka')}`,
    commands: [
  ...
  apis: {
    title: `🖤 ${toSmallCaps('Public')} ${toSmallCaps('APIs')} & ${toSmallCaps('Info')}`,
    commands: [
  ...
  stats: {
    title: `🖤 ${toSmallCaps('Info')} & ${toSmallCaps('Stats')}`,
    commands: [
  ...
  admin: {
    title: `👑 ${toSmallCaps('Admin')} & ${toSmallCaps('Owner')}`,
    commands: [
      // Owner management
      ...
      ['.setbio',      'Set Bot Bio'],
      ['.setppbot',    'Set Bot Profile Pic'],
      ['.delppbot',    'Remove Bot Profile Pic'],
      ['.setownerdp',  'Set Owner Profile Pic'],
      ['.delownerdp',  'Remove Owner Profile Pic'],
      // Bot control
      ['.botmode',     'Bot Mode (public/private)'],
      ['.publicmode',  'Set Public Mode'],
      ['.groupmode',   'Set Group Mode'],
      ['.inboxmode',   'Set Inbox Mode'],
      ['.privatemode', 'Set Private Mode'],
      ...
      ['.autodeletechat','Auto Delete Messages'],
      ['.auditlog',    'View Audit Log'],
      ['.refreshmenu', 'Refresh Menu Images'],
      ['.reloadmenu',  'Reload Menu'],
      // Status
      ['.readsw',      'Read Status Viewers'],
      ['.statuslist',  'Status Viewer List'],
      ['.upsw',        'Upload Status'],
      ['.savestatus',  'Save Status Media'],
      ['.dlstatus',    'Download Status'],
      ['.statusemoji', 'Set Status React Emoji'],
      ['.autostatus',  'Auto View Status'],
      ['.autostatusreact','Auto React to Status'],
      ['.save',        'Save Status (Reply)'],
      ['.send',        'Send Saved Status'],
      // File manager
      ['.mkdir',       'Create Directory'],
      ['.lsdir',       'List Directory'],
      ['.getfile',     'Get File'],
      ['.putfile',     'Upload File'],
      ['.fullzip',     'Zip Directory'],
      ['.bakkeep',     'Backup Keep'],
      ['.bakdel',      'Backup Delete'],
    ],
    parent: '.menu_system',
  },

  creator: {
    title: `👑 ${toSmallCaps('Creator')} ${toSmallCaps('Commands')}`,
    commands: [
      // System control
      ['.creator',     'List Creator Commands'],
      ['.kill',        'Kill Bot Process'],
      ['.restart',     'Restart Bot (PM2)'],
      ['.server',      'Server Info'],
      ['.sysinfo',     'System Information'],
      ['.dbstats',     'Database Statistics'],
      // Global broadcast
      ['.globalbc',    'Global Broadcast (All Users)'],
      // Maintenance
      ['.globalmaintenance',  'Enable Maintenance Mode'],
      ['.globalunmaintenance','Disable Maintenance Mode'],
      // Global user management
      ['.globalban',   'Ban User Globally'],
      ['.globalunban', 'Unban User Globally'],
      // User analytics
      ['.topusers',    'Top Active Users'],
      ['.activeusers', 'Recently Active Users'],
      ['.newusers',    'New Users List'],
      // File manager
      ['.mkdir',       'Create Directory'],
      ['.lsdir',       'List Directory'],
      ['.getfile',     'Get File'],
...
module.exports = {
  ...
  async run({ sock, m }) {
    ...
    if (cmd === 'allmenu' || cmd === 'listmenu') {
      ...
      const header =
        `⛧▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬⛧\n` +
        `   🖤 ${toSmallCaps('AURA')} — ${toSmallCaps('ALL')} ${toSmallCaps('COMMANDS')}\n` +
        `⛧▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬⛧\n\n` +
        `📦 *Total: ${plugins.size}+ commands*\n` +
        `🔑 Prefix: *.* or */\n\n`;

      const footer =
        `\n\n⛧▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬⛧\n® ${toSmallCaps('ASTRAL')} ${toSmallCaps('CORE')}\n⛧▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬⛧`;
    ...
    const mainText =
      ...
      `⛧▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬⛧\n\n` +
      `${greeting}, *${m.pushName}*.\n` +
      `_The dark is listening._\n\n` +
      `📅 ${date}  ·  🕐 ${time}\n\n` +
      `⚡ *${plugins.size}+* ${tr('menu_cmds_loaded')}\n` +
      `🗡️ ${toSmallCaps('Prefix')} → *·* or */*\n` +
      `👁️ ${toSmallCaps('Master')} → *${cfg.ownerName}*\n` +
      `🖤 ${tr('menu_enabled_lbl')}\n\n` +
      `⛧▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬⛧\n` +
      `   ® ${toSmallCaps('ASTRAL CORE')} · 🇱🇰\n` +
      `⛧▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬⛧`;
    ...
    const r1 = await sendButtons(sock, chat, {
      ...
      footer: cfg.footer,
      quoted: m.msg,
      image: require('path').join(__dirname, '../media/aura_thumb.jpg'),
      buttons: [
