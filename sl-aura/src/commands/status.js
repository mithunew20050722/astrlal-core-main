  ...
  async run({ sock, m }) {
    ...
    if (cmd === 'wastatus' || cmd === 'wstatus') {
      ...
      if (!text) {
        ...
        return m.reply(`📱 *AURA STATUS DOWNLOADER*\n━━━━━━━━━━━━━━━━━━━━━\n\n📂 *Available Categories:*\n\n${catList}\n\n━━━━━━━━━━━━━━━━━━━━━\n📌 Usage: *.wastatus* <category>\n\n${cfg.footer}`);
      }
