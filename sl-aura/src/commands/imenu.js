...
const LOCAL_MENU_IMAGES = [
  path.join(MEDIA_DIR, 'aura_banner_1.jpg'),
  path.join(MEDIA_DIR, 'aura_banner_2.jpg'),
  path.join(MEDIA_DIR, 'aura_thumb.jpg'),
...
const SECTIONS = [
  ...
  { file: 'menu_04.jpg', icon: '🖤', titleKey: 'imenu_title_ai',      cmd: 'aimenu',       labelKey: 'imenu_open_ai',      cmds: ['ai', 'gpt', 'llama3', 'chatai', 'clearai', 'imagine', 'flux', 'sora', 'gemini', 'openai', 'chatgpt', 'gpt3', 'gpt5', 'deepseek', 'deep', 'seekai', 'mistral', 'aurachat', 'unity', 'resetai', 'gimage', 'googleimage', 'wiki', 'wikipedia', 'whatsappstalk', 'wastalk', 'githubstalk', 'github', 'github2', 'imdb', 'cricket', 'ytstalk', 'ytinfo', 'xstalk', 'twitterstalk', 'twtstalk', 'tiktokstalk', 'tstalk', 'ttstalk', 'npm', 'npmsearch', 'npminfo', 'srepo', 'repo', 'source'] },
  ...
  { file: 'menu_16.jpg', icon: '👑', titleKey: 'imenu_title_admin',   cmd: 'adminmenu',   labelKey: 'imenu_open_admin',   cmds: ['addowner', 'delowner', 'listowner', 'addsubadmin', 'delsubadmin', 'ban', 'unban', 'mute', 'unmute', 'warn', 'unwarn', 'resetwarn', 'setname', 'setbio', 'setppbot', 'delppbot', 'setownerdp', 'delownerdp', 'botmode', 'publicmode', 'groupmode', 'inboxmode', 'privatemode', 'maintenance', 'setprefix', 'setlang', 'listgc', 'broadcast', 'bc', 'version', 'clearcache', 'clearchat', 'autodeletechat', 'auditlog', 'refreshmenu', 'reloadmenu', 'readsw', 'statuslist', 'upsw', 'savestatus', 'dlstatus', 'statusemoji', 'autostatus', 'autostatusreact', 'save', 'send'] },
  { file: 'menu_17.jpg', icon: '💎', titleKey: 'imenu_title_creator', cmd: 'creatormenu', labelKey: 'imenu_open_creator', cmds: ['creator', 'kill', 'restart', 'server', 'sysinfo', 'dbstats', 'globalbc', 'globalmaintenance', 'globalunmaintenance', 'globalban', 'globalunban', 'topusers', 'activeusers', 'newusers', 'mkdir', 'lsdir', 'getfile', 'putfile', 'fullzip', 'bakkeep', 'bakdel'] },
];
...
module.exports = {
  ...
  async run({ sock, m }) {
    ...
    const botName  = cfg.botName  || 'SL AURA';
    ...
    try {
      ...
      if (cards.length === 0) {
        ...
        console.warn('[imenu] No local images found in src/media/. Add aura_banner_1.jpg, aura_banner_2.jpg or aura_thumb.jpg');
        ...
        viewOnceMessage: {
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              ...
              footer: proto.Message.InteractiveMessage.Footer.create({ text: `® ASTRAL CORE | ${botName}` }),
