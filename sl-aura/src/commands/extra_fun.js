  ...
  async run({ sock, m }) {
    ...
    if (cmd === 'compliment') {
      ...
      return sock.sendMessage(chat, {
        text: `💜 @${target.split('@')[0]}, the AURA shines on you — ${compliment}\n\n${cfg.footer}`,
        mentions: [target],
      }, { quoted: msg });
    }
    ...
    if (cmd === 'insult') {
      ...
      return sock.sendMessage(chat, {
        text: `😂 @${target.split('@')[0]}, the AURA has spoken — ${insult}\n\n${cfg.footer}`,
        mentions: [target],
      }, { quoted: msg });
    }
    ...
    if (cmd === 'wasted') {
      ...
      try {
        ...
        await sock.sendMessage(chat, {
          ...
          caption: `⚰️ *AURA WASTED* — @${target.split('@')[0]} 💀\n\nRest in pieces! 😂\n\n${cfg.footer}`,
          mentions: [target],
        }, { quoted: msg });
        await m.react('✅');
      } catch {
